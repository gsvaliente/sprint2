...
db.restaurante.find({ cuisine: { $ne: "American" }, "address.coord.0": { $lt: -65.754168 }, "grades.score": { $gt: 70 } });
db.restaurante.find({ cuisine: { $ne: "American" }, "address.coord.1": { $lt: -65.754168 }, "grades.score": { $gt: 70 } });
...
db.restaurante.find({ borough: { $in: ["Staten Island", "Queens", "Bronx", "Brooklyn"] } });
db.restaurante.find({ borough: { $nin: ["Staten Island", "Queens", "Bronx", "Brooklyn"] } });
